...
Wikilinks to [[another post|a-fake-link]] will be transformed into Markdown link, with the link replaced to a url (`../anoter-post`). Image Wikilinks like
...
[[#math-processing|This points back to Math Processing.]]

[[another-post#math-processing|This points to a section in another post.]]
