...
- Copies used images to Jekyll assets folder and update `![[img]]` links along with alt texts and width settings.
...
- Syncs to your vault; removed posts and stale images get removed from you Jekyll site too.
...
This tool **has not** been widely tested in many different scenarios, but all my [personal blog posts](https://kckhchen.com/blog/) (in Mandarin Chinese) are generated by this tool. Generally this tool is safe to use since neither your original Obsidian posts nor your other posts on the Jekyll site will be touched. It only manages files and folders it generates. However, if you notice some quirks in display on your Jekyll site please don't hesitate to contact me. Any suggestions are welcome.
