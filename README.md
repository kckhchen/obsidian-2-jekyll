...
Neither your original Obsidian notes nor hand-authored posts on your Jekyll site are ever touched: cleanup only removes files carrying the tool's own `generator: obsidian-2-jekyll` frontmatter marker.
